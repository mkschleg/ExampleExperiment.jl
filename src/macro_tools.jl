    ...
    quote
        ...
        function $(esc(create_toml_func_name))(save_file=nothing; database=false)
            ...
            save_info = if database
                ...
                save_dir="Path/To/Save" # Directory name for exceptions, settings, and more!"""
            else
                """
                save_backend="file" # file saving mode
                file_type = "jld2" # using JLD2 as save type
                save_dir="Path/To/Save" # save location"""
            end
            ...
            making changes to this config, replace this info with useful information.
            \"\"\"
